...
const TRACKING_PARAMS = new Set([
  'fbclid', 'gclid', 'gclsrc', 'dclid', 'msclkid', 'mc_cid', 'mc_eid', 'ref', 'ref_src',
  'igshid', 'yclid', 'wickedid', 'oly_anon_id', 'oly_enc_id', '_hsenc', '_hsmi', 'vero_id',
  'spm', 'scm', 'from', 'source',
]);

const STOP = new Set([
  'the', 'and', 'for', 'you', 'your', 'are', 'with', 'this', 'that', 'from', 'how', 'what',
  'why', 'when', 'who', 'has', 'have', 'was', 'were', 'not', 'but', 'all', 'can', 'get',
  'out', 'our', 'his', 'her', 'its', 'they', 'them', 'their', 'about', 'into', 'over',
  'com', 'www', 'http', 'https', 'html', 'php', 'org', 'net', 'new', 'top', 'best', 'via',
  'home', 'page', 'search', 'google', 'results', 'more', 'here', 'now', 'one', 'two', 'use',
]);
