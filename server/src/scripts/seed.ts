...
const TRAILS: SeedTrail[] = [
  // --- dev: live, recent ---
  {
    ...
    pages: [
      {
        url: 'https://weaviate.io/developers/weaviate/concepts/engram',
        title: 'Engram: Agentic Memory | Weaviate',
      ...
      {
        url: 'https://docs.engram.weaviate.io/api/memories',
        title: 'Memories API — Engram REST Reference',
      ...
      {
        url: 'https://weaviate.io/blog/engram-ga',
        title: 'Engram is now generally available | Weaviate Blog',
      ...
      {
        url: 'https://github.com/weaviate/engram-examples',
        title: 'weaviate/engram-examples: quickstarts for Engram',
  ...
  // --- travel: live, recent ---
  {
    ...
    pages: [
      {
        url: 'https://www.tripadvisor.com/Tourism-Lisbon',
        title: 'Lisbon 2026: Best Places to Visit - Tripadvisor',
      ...
      },
      {
        ...
        title: 'Hotels in Alfama, Lisbon | Booking.com',
      ...
      {
        url: 'https://www.skyscanner.net/routes/lis/flights-to-lisbon',
        title: 'Cheap Flights to Lisbon (LIS) - Skyscanner',
      ...
      {
        url: 'https://www.omio.com/trains/lisbon-sintra',
        title: 'Lisbon to Sintra by Train - Omio',
  ...
  // --- shopping: a week old -> dormant ---
  {
    ...
    pages: [
      {
        url: 'https://www.tomshardware.com/reviews/nvidia-rtx-5090-review',
        title: "Nvidia RTX 5090 Review - Tom's Hardware",
      ...
      {
        url: 'https://www.newegg.com/p/rtx-5090-founders',
        title: 'RTX 5090 Founders Edition - Newegg',
      ...
      {
        url: 'https://pcpartpicker.com/list/rtx5090-build',
        title: '5090 Gaming Build - PCPartPicker',
  ...
  // --- projects: ten days old -> dormant ---
  {
    ...
    pages: [
      {
        url: 'https://www.youtube.com/watch?v=vanbuild01',
        title: 'Full DIY Van Conversion Timelapse - YouTube',
      ...
      {
        url: 'https://www.instructables.com/Campervan-Electrical-System/',
        title: 'Campervan Electrical System - Instructables',
      ...
      {
        url: 'https://www.reddit.com/r/vandwellers/comments/insulation',
        title: 'Best insulation for a van build? - r/vandwellers',
...
if (ENRICH) {
  ...
  const ids = db.prepare('SELECT id FROM trails WHERE page_count >= 2 ORDER BY last_active DESC').all() as {
    id: string;
  }[];
  console.log(
    `[seed] enriching ${ids.length} trail(s) via the LLM — one or two model calls each, so this takes a minute…`,
  );
  for (let i = 0; i < ids.length; i++) {
    ...
    const t = db.prepare('SELECT label, category, summary_source FROM trails WHERE id = ?').get(id) as {
      label: string;
      category: string | null;
      summary_source: string | null;
    };
    console.log(
      `\r${tag} ${t.label}  ·  ${t.category || '?'}  ·  recap:${t.summary_source || 'n/a'}        `,
    );
  }
